    ...
    <div className="flex-1 flex">
      <div className="flex-1 p-8">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center space-x-4">
            <div className="relative">
              ...
              <input 
                type="text" 
                placeholder="Search friends, activities..."
                value={searchQuery}
                onChange={(e) => setSearchQuery(e.target.value)}
                className="pl-10 pr-4 py-2 bg-gray-100 rounded-xl border-0 focus:ring-2 focus:ring-purple-500 focus:bg-white transition-all w-64"
              />
            </div>
            <div className="w-10 h-10 bg-gradient-to-br from-purple-400 to-pink-400 rounded-xl flex items-center justify-center cursor-pointer hover:scale-105 transition-transform">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="bg-purple-100 rounded-lg px-4 py-2">
              <select 
                ...
                className="bg-transparent text-purple-700 font-medium border-0 focus:ring-0 cursor-pointer"
              >
                <option>Daily</option>
          ...
          <div className="grid grid-cols-3 gap-6">
            {/* Steps Chart Card */}
            <div className="col-span-2 bg-gradient-to-br from-purple-600 to-purple-700 rounded-3xl p-6 text-white relative overflow-hidden">
              <div className="relative z-10">
                ...
                <div className="mb-6 h-20 relative">
                  ...
                  <div className="absolute bottom-0 flex justify-between text-xs text-purple-300 w-full">
                    <span>Jan</span>
                    <span>Feb</span>
                    <span>Mar</span>
                    <span>Apr</span>
                ...
                <div className="flex justify-between">
                  <div>
                    <p className="text-purple-200 text-sm">Active Time</p>
                    <p className="text-2xl font-bold">{activeTime} Hr</p>
                  </div>
                  <div>
                    <p className="text-purple-200 text-sm">Total Steps</p>
                    <p className="text-2xl font-bold">{currentSteps.toLocaleString()} St</p>
                  </div>
                  <div>
                    <p className="text-2xl font-bold">{goalSteps.toLocaleString()} St</p>
                    <p className="text-purple-200 text-sm">Goal</p>
                  </div>
                </div>
            ...
            <div className="space-y-4">
              <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-3xl p-6 text-white relative cursor-pointer hover:scale-105 transition-transform">
                <div className="flex items-center justify-between mb-4">
                  <Activity size={24} />
                ...
                <h3 className="font-semibold mb-1">Daily Jogging</h3>
                <p className="text-purple-200 text-sm">30 min • 4 days a week</p>
              </div>

              <div className="bg-gradient-to-br from-pink-500 to-red-500 rounded-3xl p-6 text-white relative cursor-pointer hover:scale-105 transition-transform">
                <div className="flex items-center justify-between mb-4">
                  <Target size={24} />
                  <button className="text-white/70 hover:text-white transition-colors">
                    <span className="text-xl">→</span>
                ...
                <h3 className="font-semibold mb-1">My Jogging</h3>
                <div className="flex justify-between items-end">
                  <div>
                    <p className="text-pink-200 text-sm">Total Time</p>
                    <p className="text-2xl font-bold">{activeTime} hr</p>
                  </div>
                </div>
              </div>
        ...
        <div className="grid grid-cols-3 gap-6">
          {activities.map((activity) => (
            <div key={activity.id} className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex items-center justify-between mb-4">
              ...
              <p className="text-sm text-gray-500 mb-4">{activity.duration} • {activity.frequency}</p>
      ...
      <div className="w-80 bg-gray-50 p-6">
        ...
        <div className="mb-8">
          ...
          <div className="space-y-4 max-h-64 overflow-y-auto">
            {filteredFriends.map((friend) => (
              <div key={friend.id} className="flex items-center justify-between hover:bg-white rounded-lg p-2 transition-colors">
                <div className="flex items-center space-x-3">
                  <div className={`w-10 h-10 bg-gradient-to-br ${friend.color} rounded-xl flex items-center justify-center relative`}>
        ...
        <div>
          ...
          <div className="bg-gray-200 rounded-2xl h-40 relative overflow-hidden cursor-pointer hover:bg-gray-300 transition-colors">
            <div className="absolute inset-0 bg-gradient-to-br from-green-100 to-blue-100">
              {/* Map placeholder with user avatars */}
              <div className="absolute top-4 left-4 w-8 h-8 bg-gradient-to-br from-purple-400 to-purple-500 rounded-full flex items-center justify-center animate-pulse">
                <span className="text-white font-bold text-xs">MS</span>
              </div>
              <div className="absolute top-12 right-8 w-8 h-8 bg-gradient-to-br from-orange-400 to-red-500 rounded-full flex items-center justify-center animate-pulse">
                <span className="text-white font-bold text-xs">GJ</span>
              </div>
              <div className="absolute bottom-8 left-8 w-8 h-8 bg-gradient-to-br from-blue-400 to-blue-500 rounded-full flex items-center justify-center animate-pulse">
                <span className="text-white font-bold text-xs">LP</span>
              </div>
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="bg-white/80 rounded-lg px-3 py-1 text-sm text-gray-700">
                  3 friends nearby
                </div>
              </div>
            </div>
